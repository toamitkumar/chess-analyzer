    ...
    <div class="min-h-screen flex items-center justify-center p-4 bg-background">
      <div class="w-full max-w-md">
        <div class="border border-border/50 shadow-xl rounded-lg bg-card text-card-foreground">
          ...
          <!-- Form -->
          <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="px-6 pb-4">
            <div class="space-y-4">
              <!-- Email -->
              <div class="space-y-2">
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    [class.border-destructive]="loginForm.get('email')?.invalid && loginForm.get('email')?.touched"
                  />
                </div>
              ...
              <div class="space-y-2">
                <div class="flex items-center justify-between">
                  ...
                  <a routerLink="/auth/reset-password" class="text-sm text-primary hover:underline">
                    Forgot password?
                  </a>
                </div>
                <div class="relative">
                  ...
                  <input
                    ...
                    [class.border-destructive]="loginForm.get('password')?.invalid && loginForm.get('password')?.touched"
                  />
                  <button
                    type="button"
          ...
          <div class="border-t border-border/50 p-6 pt-4">
            <p class="text-sm text-muted-foreground text-center">
              ...
              <a routerLink="/sign-up" class="text-primary hover:underline font-medium ml-1">
                Sign up
              </a>
            </p>
          </div>
